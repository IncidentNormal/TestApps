...
class MacOut(Process):
    ...
    def go(self):
        while True:
            ...
            Vis.RemoveFromQueue(self.ID,False)
...
##    def channelOn(self):
##        chn_no = 0
##        for chn in self.LabelList:
##            if chn.color==v.color.red and chn_no<len(self.LabelList):
##                chn_no += 1
##        self.LabelList[chn_no].color=v.color.red
##    def channelOff(self):
##        chn_no = 0
##        for chn in self.LabelList:
##            if chn.color==v.color.green and chn_no<len(self.LabelList):
##                chn_no += 1
##        self.LabelList[len(self.LabelList)-chn_no-1].color=v.color.green
